                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header ">
                                <a href="#myModalcabang" data-toggle="modal" data-toggle="tooltip" title="Tambah Cavabg"
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($cabang as $key => $c)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-warning"
                                                        data-toggle="modal"
                                                        data-target="#myModaleditcabang{{ $c->id }}">
                                                        <i class="fas fa-pencil-alt"></i> Edit
                                                    </button>



                                                    <form action="{{ route('destory_cabang', $c->id) }}" method="POST"
                                                        class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                            ...
                                            @include('Masterdata.modal.modaleditcabang')
                                        @endforeach
                                    </tbody>
                                </table>
