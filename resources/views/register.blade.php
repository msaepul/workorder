...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h3"><b>Sistem Opersional</b><br>Work Order</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg h5"><b>Register a new membership</b></p>
      <p>Isi Identitas Pribadi</p>
      <form action="" method="post">
        @csrf
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Full name" id="nama_lengkap" name="nama_lengkap" required>
       ...
       <div class="input-group mb-3">
        ...
        <div class="input-group mb-3">
          <select class="form-control select2" style="width: 100%;" id="cabang_id" name="cabang_id" required>
        ...
        <div class="input-group mb-3">
          <select class="form-control select2" style="width: 100%;" id="departemen_id" name="departemen_id" required>
